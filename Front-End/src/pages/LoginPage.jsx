      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Sign in to your ShopBee account
          </p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit} noValidate>
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full rounded-xl border px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 outline-none transition focus:ring-2 ${
                errors.email
        ...
        <button className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-300 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-50">
